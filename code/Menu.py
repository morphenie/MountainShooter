...
class Menu:
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.menu_text(50, "Mountain", COLOR_ORANGE, ((WIN_WIDTH / 2), 70))  # Escrever o texto, não pode vir antes da imagem para ele não ficar por baixo dela
            self.menu_text(50, "Shooter", (255, 128, 0), ((WIN_WIDTH / 2), 120))  # Escrever o texto, não pode vir antes da imagem para ele não ficar por baixo dela
